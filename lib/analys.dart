      ...
      body: Stack(children: [
        ...
        Positioned(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "يقوم هذا التحليل بتقييم أداء اللاعب أو الفريق خلال التدريبات أو المباريات. يشمل إحصائيات مثل السرعة، المسافة المقطوعة، دقة التمريرات، وعدد التسديدات. الهدف منه هو معرفة نقاط القوة والضعف لتحسين الأداء الرياضي.",
