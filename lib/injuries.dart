      ...
      body: Stack(children: [
        ...
        Positioned(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'يركز هذا التحليل على تتبع الإصابات السابقة والحالية، ومعرفة أسبابها، ومدة التعافي، وتكرار الإصابة. يستخدم لتحسين خطط الوقاية وإعادة التأهيل، وتقليل خطر الإصابة مرة أخرى عن طريق تحليل نمط اللعب والحمل البدني.',
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Injuriesdeta(),
                        ),
                      );
                    },
                    child: const Text(
